...
import com.sogou.test.ExpressionFormatterUtils;
import static com.sogou.test.ExpressionFormatterUtils.formatExpression;
import static com.sogou.test.ExpressionFormatterUtils.formatGroupBy;
import static com.sogou.test.ExpressionFormatterUtils.formatOrderBy;
import static com.sogou.test.ExpressionFormatterUtils.formatSortItems;
import static com.sogou.test.ExpressionFormatterUtils.formatStringLiteral;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.collect.Iterables.getOnlyElement;
import static java.util.stream.Collectors.joining;

public final class SqlFormaterTest
{
  private static final String INDENT = "   ";
  private static final Pattern NAME_PATTERN = Pattern.compile("[a-z_][a-z0-9_]*");

  private SqlFormaterTest() {}
          ...
          extends AstVisitor<Void, Integer>
  {
    ...
    {
      builder.append(formatName(QualifiedName.of("a", "b", "c")));
